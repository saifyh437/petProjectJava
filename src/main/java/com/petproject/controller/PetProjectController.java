...
public class PetProjectController {
	...
	public List<PetResponse> getPetName(@RequestParam String petName) 
	{
		List<PetResponse> allPets = (List<PetResponse>) petService.findPetName(petName);
